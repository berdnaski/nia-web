...
interface LivingTogetherStepProps {
  onNext?: () => void
  onPrevious?: () => void
}

export default function LivingTogetherStep({ onNext, onPrevious }: LivingTogetherStepProps) {
  const [livingTogether, setLivingTogether] = useState<string>('')

  const handleOptionSelect = (option: string) => {
    setLivingTogether(option)
  }
