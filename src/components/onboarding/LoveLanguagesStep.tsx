...
export default function LoveLanguagesStep({ onNext, onPrevious }: LoveLanguagesStepProps) {
          ...
          <div className="relative bg-[#CDEAFF] rounded-2xl shadow-lg p-6 sm:p-8 border max-w-md sm:max-w-lg">
            ...
            <div className="text-left">
              <h2 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 leading-relaxed">
                O que mais faz vocês se sentir conectado(a) e valorizado(a) no dia a dia? (5 linguagens do amor)
              </h2>
            </div>
          </div>
        </div>
